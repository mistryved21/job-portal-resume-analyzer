        ...
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                ...
                <Button
                    onClick={() => {
                        if (!user) {
                            toast.error("Please login before applying for this job!");
                            navigate("/login");
                            return;
                        }
                        if (!isApplied) {
                    ...
                    disabled={isApplied}
                    className={`rounded-lg px-4 py-2 text-white font-bold transition ${isApplied
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Requirement:
